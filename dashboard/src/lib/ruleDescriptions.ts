...
export const RULE_DESCRIPTIONS: Record<string, string> = {
	...
	"GLOBAL-BUILTIN-SENSITIVE-DATA":
		"Blocks sensitive data exposure (keys, tokens)",
	...
	"PY-CODE-018": "Python oversized module",
	"PY-IMPORT-001": "Python import fan-out too wide",
	"PY-IMPORT-002": "Python non-standard import aliases",
	"PY-LOG-002": "Python event boundary logging or telemetry",
	"PY-AST-001": "Python AST parse health failure",
