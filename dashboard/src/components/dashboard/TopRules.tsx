import {
  ComposedChart, Bar, Line, XAxis, YAxis, ResponsiveContainer, Cell, Tooltip, LabelList,
  PieChart, Pie, Legend,
} from "recharts";
...
const SEVERITY_LABELS: Record<Severity, string> = { LOW: "Low", MEDIUM: "Med", HIGH: "High", CRITICAL: "Crit" };
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <XAxis
                    ...
                    domain={[0, 100]}
                    tickFormatter={(v) => `${v}%`}
                    tick={{ fontSize: 8, fontFamily: "JetBrains Mono", fill: "hsl(var(--signal-allow))" }}
                    axisLine={false}
                    tickLine={false}
                  />
                    <YAxis
